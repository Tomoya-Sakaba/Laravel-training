    ...
    <div class="flex justify-between font-robotoFlex">
      ...
      <div class="flex mt-3">
        ...
        <div class="flex pb-2 rounded-md">
          <img src="/images/document.png" class="w-6 h-6 mt-2.5 ml-3 mr-3" />
        ...
        <div class="flex pb-2 mr-2 rounded-md">
          ...
          <a href="#" class="text-lg mt-2 mr-8 font-semibold">アカウント情報</a>
        </div>
        <div class="bg-qa-darkGray flex mr-6 rounded-md">
          <img src="/images/key.png" class="w-6 h-6 mt-2 ml-8 mr-3" />
          <a href="#" class="text-lg text-white mt-2 mr-8 font-semibold">ログアウト</a>
        </div>
      </div>
    </div>
            ...
            <div class="flex mt-1.5">
              ...
              <div class="w-full">
                <div class="relative">
                  ...
                  <button type="submit" class="text-white absolute right-2.5 bottom-2 bg-qa-blue  font-medium font-robotoFlex text-sm px-4 py-2 mt-1">
                    検索
                  </button>
                </div>
              </div>
